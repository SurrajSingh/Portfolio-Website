    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='w-64 sm:w-80 rounded-3xl max-w-none'>
          <Image src={assets.user_image} className='w-full rounded-4xl shadow-darkTheme dark:shadow-white' alt='user' />
        </motion.div>
        ...
        className='flex-1'>
          ...
          className='flex items-center gap-3 sm:gap-5'>
            {toolsData.map((tool, index) => (
                ...
                className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500 hover:shadow-black dark:bg-[rgb(42,0,74)] dark:hover:shadow-white' key={index}>

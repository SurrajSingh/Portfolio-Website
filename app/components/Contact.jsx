...
const Contact = () => {
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center dark:bg-none '>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>I’d love to hear from you! If you have any questions, comments, or feedback, feel free to use the form below to reach out.</motion.p>
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black hover:shadow-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover dark:hover:shadow-white '>Submit Now <Image src={assets.right_arrow_white} className='w-4' alt='' /> </motion.button>
